report 50030 MyReport
{
    ...
    begin
        IF "AZ Setup".FindSet THEN
            REPEAT
                ...
                "AUZ AZ Setup"."Sales Chart G/L Acc. Filter" := "AZ Setup"."Sales Chart G/L Account Filter";
        ...
        IF "Expense Code".FindSet THEN
            REPEAT
                ...
                "AUZ Expense Code"."Unit of Measure Code" := "Expense Code"."Unit of Measure";
        ...
        IF "Case Hour Expense".FindSet THEN
            REPEAT
                ...
                "AUZ Case Hour Expense"."Case Line No." := "Case Hour Expense"."Case Hour Line No.";
                ...
                "AUZ Case Hour Expense"."Unit of Measure Code" := "Case Hour Expense"."Unit of Measure";
        ...
        IF "Job Expense".FindSet THEN
            REPEAT
                ...
                "AUZ Job Expense"."Unit of Measure Code" := "Job Expense"."Unit of Measure";
        ...
        IF "Case Hour Description".FindSet THEN
            REPEAT
                ...
                "AUZ Case Hour Description"."Case Line No." := "Case Hour Description"."Case Hour Line No.";
    ...
    var
        ...
        "AUZ AZ Setup": Record "AUZ Role Center Setup";
        ...
        "AUZ External File": Record "AFM File Transfer Entry";
