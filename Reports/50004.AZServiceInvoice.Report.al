            ...
            dataitem(TempLine; "Service Invoice Line")
            {
                ...
                begin
                    ...
                    if not ShowExtendedText then
                        if TempLine."AUZ Serv. Contract Line From Date" <> 0D then
                            if TempLine."AUZ Serv. Contract Line From Date" <> CalcDate('<-CM>', TempLine."AUZ Serv. Contract Line From Date") then
