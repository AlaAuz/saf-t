report 50093 "AUZ Sales Cr.Memo"
{
            ...
            dataitem(Lines; "Sales Cr.Memo Line")
            {
                ...
                begin
                    ...
                    if JobPlanningLine.FindFirst then
                        if not Cases.Get(JobPlanningLine."AUZ Case No.") then
                            Cases.Init;

                    CaseDescription := StrSubstNo('Saksnr.: %1 -%2', Cases."No.", Cases.Description);
    ...
    var
        ...
        TxtDocumentHeader: Label 'Credit Memo %1';
