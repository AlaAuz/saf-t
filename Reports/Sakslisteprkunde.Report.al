    ...
    dataset
    {
        dataitem("Case Header"; "Case Header")
        {
            ...
            dataitem("Case Line"; "Case Line")
            {
                ...
                dataitem("Case Hour Description"; "Case Hour Description")
                {
                    DataItemLink = "Case No." = FIELD ("Case No."), "Case Hour Line No." = FIELD ("Line No.");
                    DataItemTableView = SORTING ("Case No.", "Case Hour Line No.", "Line No.") WHERE (Description = FILTER (<> ''));
