report 50101 "AUZ Suggest Job Jnl. Lines"
{
    ...
    var
        ...
        LineNo: Integer;
        QtyToPost: Decimal;
        TempCaseHours: Record "AUZ Case Line" temporary;
        ...
        if TempCaseHours.FindSet then begin
            ...
            repeat
                ...
                if QtyToPost <> 0 then begin
                    ...
                    JobJnlLine."AUZ Case No." := TempCaseHours."Case No.";
                    JobJnlLine."AUZ Case Line No." := TempCaseHours."Line No.";
                    JobJnlLine."AUZ Case Description" := TempCaseHours."Case Description";
    ...
    local procedure FillTimeSheetLineBuffer(var TempCaseHours: Record "AUZ Case Line" temporary)
    var
        CaseHours: Record "AUZ Case Line";
    begin
        TempCaseHours.Reset;
