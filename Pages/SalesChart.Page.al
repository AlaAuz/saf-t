page 50089 "Sales Chart"
{
        ...
        area(content)
        {
            ...
            usercontrol(BusinessChart; "Microsoft.Dynamics.Nav.Client.BusinessChart")
            {
                ...
                begin
                    ...
                    SalesChartMgt.DrillDown(Rec, SalesChartSetup."Chart View"::Sales);
                end;
                ...
                trigger AddInReady()
                begin
                    SalesChartMgt.OnOpenPage(SalesChartSetup, SalesChartSetup."Chart View"::Sales);
                    NeedsUpdate := true;
                    UpdateStatus;
    ...
    var
        ...
        OldSalesChartSetup: Record "Sales Chart Setup";
    ...
    begin
        ...
        if not IsChartAddInReady then
            exit;
        SalesChartMgt.UpdateData(Rec, SalesChartSetup."Chart View"::Sales);
