page 90023 "Completed Cases"
{
    ...
    var
        ...
        ResourceFilter: Text;
    begin
        UserSetup.SetRange(Developer, true);
        UserSetup.SetRange("Development Administrator", false);
        UserSetup.SetFilter("Resource No.", '<>%1', '');
        if UserSetup.FindSet then
            repeat
                if ResourceFilter <> '' then
                    ResourceFilter += '|';
                ResourceFilter += StrSubstNo('*%1*', UserSetup."Resource No.");
