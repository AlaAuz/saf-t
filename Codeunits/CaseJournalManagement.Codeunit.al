codeunit 90020 "Case Journal Management"
{
    ...
    var
        ...
        InsertCaseHoursQst: Label 'Do you want to insert case hours?';
    ...
    procedure InsertCaseHourJnlDescriptions(CaseHourJnlLine: Record "Case Journal Line")
    var
    ...
    local procedure InsertCaseHourFromJnl(var CaseHourJnlLine: Record "Case Journal Line"; var CaseHourLineNo: Integer; CaseHeader: Record "Case Header")
    var
    ...
    local procedure InsertCaseHourDescriptions(CaseHourJnlLine: Record "Case Journal Line"; CaseHourLineNo: Integer)
    var
        CaseHourJournalLineDesc: Record "Case Journal Line Description";
        CaseHourDescription: Record "Case Hour Description";
        LineNo: Integer;
    begin
        CaseHourJournalLineDesc.SetRange("Resource No.", CaseHourJnlLine."Resource No.");
        CaseHourJournalLineDesc.SetRange("Journal Line No.", CaseHourJnlLine."Line No.");
        if CaseHourJournalLineDesc.FindSet then
            repeat
                ...
                CaseHourDescription."Case Hour Line No." := CaseHourLineNo;
    ...
    local procedure SetCaseSolution(var CaseHourJnlLine: Record "Case Journal Line"; var CaseHeader: Record "Case Header")
    var
        Description: Text;
        Solution: Text;
    begin
    ...
    local procedure SetModifiedObjectText(var CaseHourJnlLine: Record "Case Journal Line")
    var
        CaseHandleObjects: Codeunit "Case Handle Objects";
