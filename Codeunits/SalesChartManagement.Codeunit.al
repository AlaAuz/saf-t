codeunit 50050 "Sales Chart Management"
{
    ...
    var
        ...
        SalesChartSetup: Record "Sales Chart Setup";
    ...
    local procedure CalcBudgetAmount(AZSetup: Record "AZ Setup"; SalesChartSetup: Record "Sales Chart Setup"; FromDate: Date; ToDate: Date): Decimal
    var
        GLBudgetEntry: Record "G/L Budget Entry";
    begin
        SetBudgetFilter(GLBudgetEntry, AZSetup, SalesChartSetup, FromDate, ToDate);
    ...
    local procedure SetBudgetFilter(var GLBudgetEntry: Record "G/L Budget Entry"; AZSetup: Record "AZ Setup"; SalesChartSetup: Record "Sales Chart Setup"; FromDate: Date; ToDate: Date)
    begin
    ...
    local procedure CalcActualAmount(AZSetup: Record "AZ Setup"; SalesChartSetup: Record "Sales Chart Setup"; FromDate: Date; ToDate: Date): Decimal
    var
        GLEntry: Record "G/L Entry";
    begin
        SetActualFilter(GLEntry, AZSetup, SalesChartSetup, FromDate, ToDate);
    ...
    local procedure SetActualFilter(var GLEntry: Record "G/L Entry"; AZSetup: Record "AZ Setup"; SalesChartSetup: Record "Sales Chart Setup"; FromDate: Date; ToDate: Date)
    begin
