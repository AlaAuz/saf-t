codeunit 50052 "AUZ Case Mail Management"
{
    procedure SendEmail(CaseHeader: Record "AUZ Case Header")
    var
    ...
    begin
        ...
        if CaseEmailTemplate.Internal then begin
            if ToDevelopmentAdmin or CaseEmailTemplate."To Development Admin." then begin
                UserSetup.Reset;
                UserSetup.SetRange("AUZ Development Administrator", true);
                FillEMailString;
            end;
            ...
            if CaseEmailTemplate."To Resources" then begin
                ...
                if CaseResource.FindSet then
                    repeat
                        UserSetup.Reset;
                        UserSetup.SetRange("AUZ Resource No.", CaseResource."Resource No.");
                        FillEMailString;
