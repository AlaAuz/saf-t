codeunit 50003 "Merge Service Invoice Lines"
{
    ...
    begin
        ...
        repeat
            ...
            if not NewGroup then begin
                ...
                InvToDate := ServInvLine."Serv. Contract Line To Date";
            end;
    ...
    begin
        if (ServInvLine."Serv. Contract Line From Date" <> 0D) and
          (ServInvLine."Serv. Contract Line To Date" <> 0D) and
    ...
    begin
        ...
        TempLine."Description 2" := StrSubstNo('%1 - %2', ServInvLine."Serv. Contract Line From Date", ServInvLine."Serv. Contract Line To Date");
        TempLine.Modify;
    end;
}
