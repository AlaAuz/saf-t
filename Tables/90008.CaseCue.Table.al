table 90008 "AUZ Case Cue"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE ("Resource Search Text" = FIELD ("Resource Filter"),
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE ("Promised Shipment Date" = FIELD ("Promised Delivery Date Filter"),
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE (Status = FILTER ("Not Started" | "In Progress" | "Waiting for Reply"),
                                                     Priority = CONST (High),
                                                     "Consultant ID" = FIELD ("Consultant Filter"),
                                                     "Developer ID" = FIELD ("Developer Filter")));
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE ("Registered By" = FIELD ("Resource Filter"),
                                                     Status = FILTER ("Not Started" | "In Progress" | "Waiting for Reply" | "See Comment")));
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE (Status = CONST ("Waiting for Reply"),
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE ("Development Status" = CONST ("Ready for Testing"),
                                                     Status = CONST ("Waiting for Reply"),
                                                     "Waiting for" = FIELD ("Waiting for Filter"),
                                                     "Consultant ID" = FIELD ("Consultant Filter"),
                                                     "Developer ID" = FIELD ("Developer Filter")));
        ...
        {
            CalcFormula = Count ("AUZ Case Header" WHERE ("Development Status" = CONST ("Ready for Installation"),
                                                     Status = CONST ("Waiting for Reply"),
                                                     "Waiting for" = FIELD ("Waiting for Filter"),
                                                     "Consultant ID" = FIELD ("Consultant Filter"),
                                                     "Developer ID" = FIELD ("Developer Filter")));
        ...
        field(106; "Developer Filter"; Code[50])
        {
            ...
            FieldClass = FlowFilter;
            TableRelation = "User Setup" WHERE ("AUZ Development Administrator" = CONST (true));
        }
    }
    keys
    {
