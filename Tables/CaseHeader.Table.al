table 90000 "Case Header"
{
    // AZ99999 12.05.2015 HHV Added norwegian translation to status and priority
    ...
    fields
    {
        ...
        field(5; "Contact No."; Code[20])
        {
            ...
            begin
                if Cont.Get("Contact No.") then begin
                    ...
                    if (Cont."Default Job No." = '') and (Cont."Default Job Task No." = '') then
                        if Cont.Get("Contact Company No.") then;
                    Validate("Job No.", Cont."Default Job No.");
                    Validate("Job Task No.", Cont."Default Job Task No.");
                end else
            ...
            begin
                if Closed then begin
                    if "Development Status" <> "Development Status"::Installed then begin
                        ...
                        if UserSetup.FindFirst and UserSetup.Developer then
            ...
            begin
                if "Contact Company No." <> '' then
                    if ContBusinessRelation.FindByContact(ContBusinessRelation."Link to Table"::Customer, "Contact Company No.") then begin
                        ...
                        Validate("Consultant ID", Cust."Consultant ID");
                        Validate("Developer ID", Cust."Developer ID");
                    end else begin
        ...
        field(50003; "Registered By"; Code[10])
        {
            Caption = 'Registered By';
            TableRelation = Resource;
        }
        field(50004; "Desc. Change Request"; BLOB)
        {
            Caption = 'Endringsbeskrivelse';
        }
        field(50005; "Desc. Solution"; BLOB)
        {
            Caption = 'Løsningsbeskrivelse';
        }
        field(50006; "Work Type Code"; Code[10])
        {
            Caption = 'Work Type Code';
            TableRelation = "Work Type";
        }
        field(50007; Estimate; Decimal)
        {
            Caption = 'Estimat';
        }
        field(50008; "Agreed Estimate"; Boolean)
        {
            Caption = 'Agreed Estimate';
            DataClassification = ToBeClassified;
        }
        field(50009; "Promised Shipment Date"; Date)
        {
            Caption = 'Promised Shipment Date';
        }
        field(50010; "Resource Search Text"; Text[250])
        {
        ...
        field(50012; Datefilter; Date)
        {
            Caption = 'Datofilter';
        }
        field(50013; "Development Approval Status"; Option)
        {
            ...
            begin
                if "Development Approval Status" <> xRec."Development Approval Status" then
                    if (not UserSetup.Get(UserId)) or (not UserSetup."Development Administrator") then
                        Error(Text003);
            end;
        }
        field(50014; "Development Status"; Option)
        {
            ...
            trigger OnValidate()
            var
                CaseMailMgt: Codeunit "Case Mail Management";
            begin
        ...
        field(50015; "Standard Solution No."; Code[20])
        {
    ...
    var
        ...
        CaseObject: Record "Case Object";
        CaseResource: Record "Case Resource";
        RelatedCase: Record "Related Case";
        CaseStandardSolultion: Record "Case Standard Solultion";
    begin
    ...
    var
        ...
        FieldRef: FieldRef;
    begin
        RecordRef.Open(DATABASE::"Case Header");
